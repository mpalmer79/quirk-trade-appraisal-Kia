...
(function i18nFull(){
  ...
  const MAP_EN_ES = new Map([
    ...
    ["backToDealer", "Volver a Quirk Kia Dorchester Braintree"],
    ["successTitle", "¡Gracias! - Quirk Kia Dorchester Braintree"],
    ["successHeading", "¡Gracias!"],
    ["successMessage", "Hemos recibido los detalles de su intercambio. Un especialista de Quirk Kia Dorchester Braintree se pondrá en contacto con usted en breve."]
  ]);
